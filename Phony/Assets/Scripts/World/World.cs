...
public class Weather {
    ...
    public class DTT {
        ...
        public float time;
        public DTT() { }
        public DTT(DayTime DT, float TIME) { dt = DT; time = TIME; }
    }
    /// <summary>
    ...
    public Weather (){
        if (assocTime.Count == 0) {
            assocTime.Add(new DTT(DayTime.Dawn, 6.00f));
            assocTime.Add(new DTT(DayTime.Morning, 7.00f));
            assocTime.Add(new DTT(DayTime.Noon, 11.00f));
            assocTime.Add(new DTT(DayTime.Afternoon, 13.00f));
            assocTime.Add(new DTT(DayTime.Dusk, 18.00f));
            assocTime.Add(new DTT(DayTime.Night, 20.00f));
        }
    }
