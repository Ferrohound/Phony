...
public class Whitenoise : MonoBehaviour {
	...
	void Start () {
		...
		WhitenoiseMaterial.SetFloat("_AX", OGXAmp);
		WhitenoiseMaterial.SetFloat("_AY", OGYAmp);
		WhitenoiseMaterial.SetFloat("_AZ", OGZAmp);
		
		WhitenoiseMaterial.SetFloat("_TexBlend", 1);
